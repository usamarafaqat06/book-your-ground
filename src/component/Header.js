...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 w-full z-50 transition duration-400 bg-[#090E18] ">
      <div className="container mx-auto px-4 bg-[#090E18]">
        <nav className="navbar flex items-center justify-between border-b-2 border-gray-300 py-2 ">
          ...
          <div className="hidden lg:flex lg:items-center lg:justify-end lg:space-x-12">
            <ul className="flex items-start space-x-8">
              <li>
                <Link to="/" className="nav-link text-white text-md font-semibold uppercase tracking-wide hover:text-[#0AA70A] transition-colors duration-300 relative">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="nav-link text-white text-md font-semibold uppercase tracking-wide hover:text-[#0AA70A] transition-colors duration-300 relative">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="nav-link text-white text-md font-semibold uppercase tracking-wide hover:text-[#0AA70A] transition-colors duration-300 relative">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="" className="text-white text-md font-semibold uppercase px-4 py-2 rounded-full bg-[#0AA70A] border-[#0AA70A] transition-all duration-500 border-2 hover:border-blue-500">
                  Register
                </Link>
              </li>
            </ul>
